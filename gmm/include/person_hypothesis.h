...
namespace mc3d
{
    ...
    protected:
        ...
        Tensor spline_parameters; // spline_parameter.sizes() == {pose_parameter.nb_keypoints,nb_spline_parameter,3} requires_grad
        Tensor scale_factor; // requires_grad

        const MultivariateNormal scale_mvn;
    };
}
